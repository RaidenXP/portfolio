...
const DataExtractionPage = () => {
  const {ref: codeFirstRef, inView: codeFirstView, entry: codeFirstEntry} = useInView({
    threshold: 1
  });
  const {ref: codeSecondRef, inView: codeSecondView, entry: codeSecondEntry} = useInView({
    threshold: 0.2
  });
  const {ref: codeThirdRef, inView: codeThirdView, entry: codeThirdEntry} = useInView({
    threshold: 0.2
  });
  const {ref: codeFourthRef, inView: codeFourthView, entry: codeFourthEntry} = useInView({
    threshold: 0.2
  });
  ...
  projectDataExtract[0].inView = codeFirstView || codeSecondView || codeThirdView || codeFourthView
    ...
    <>
      ...
      >
        <div className='max-w-none'>
          ...
          />
          <p ref={codeSecondRef} className="my-5">
          ...
          <Code
            ...
            startingNum={4}
          />
          <p ref={codeThirdRef} className="my-5">
          ...
          />
          <p ref={codeFourthRef} className="my-5">
