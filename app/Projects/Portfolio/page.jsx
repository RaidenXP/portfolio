...
const PortfolioDescription = () => {
  return (
    <>
      ...
      <div
        className='relative max-w-screen-xl px-4 py-10 mx-auto md:flex md:py-10 md:flex-row'
      >
        <div
          className='hidden md:flex w-[284px] md:shrink-0 sticky top-[121px] h-[calc(100vh-121px)] md:flex-col
          md:justify-between'
        >
          <nav
